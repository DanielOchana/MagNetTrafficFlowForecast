...
#python ./sparse_Magnet.py  --epochs 3000 --lr 0.005 --num_filter 16 --q 0.1 --log_path try_8_930  --data_path ../dataset/ --dataset traffic/spatial  --K 1  --layer 2 --dropout 0.5 -a 

../parallel -j18 --resume-failed --results ../Output/midtertm2 --joblog ../joblog/midtertm2  CUDA_VISIBLE_DEVICES=1  python ./sparse_Magnet.py  --epochs 3000 --lr {1} --num_filter {2} --q {3} --log_path try_8_930  --data_path ../dataset/ --dataset traffic/spatial  --K 1  --layer 2 --dropout 0.5 -a ::: 0.01 0.005 ::: 32  ::: 0.15 